		...
		public static string FailText(string level, int score)
		{
			...
			switch (info.GoalType)
			{
				case 0:
					...
					break;
				case 1: // more
					return string.Format("You needed {0:0} more points to finsh.", info.GoalScore - score);
				case 2: // equal
					return string.Format("You needed exactly {0:0} points to finsh.", info.GoalScore);
				case 3: // less
					return string.Format("You needed {0:0} fewer points to finsh.", score - info.GoalScore);
			}
			return "Unknown goal";
		}
